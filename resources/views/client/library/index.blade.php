<x-client>
    ...
    <div class="carousel w-full h-[80vh]  ">
        <div id="slide1" class=" hero carousel-item relative w-full">
            <img src="{{ asset('images/article1.jpg') }}" class="h-[80vh] w-[100vw] " />
            <div class="hero-overlay bg-opacity-60"></div>
            <div class="hero-content text-center text-neutral-content">
                <div class=" max-w-2xl">
                  <h1 class="mb-5 text-7xl font-bold">Explore the World of Knowledge</h1>
                  <p class="mb-5  text-lg text-gray-400">Unlock endless possibilities with our vast collection of books</p>
                </div>
              </div>
        ...
        <div id="slide2" class=" hero carousel-item relative w-full">
            <img src="{{ asset('images/article2.jpg') }}" class="h-[80vh] w-[100vw] " />
            <div class="hero-overlay bg-opacity-60"></div>
            <div class="hero-content text-center text-neutral-content">
                <div class=" max-w-2xl">
                    <h1 class="mb-5 text-7xl font-bold">Explore the World of Knowledge</h1>
        ...
        <div id="slide3" class=" hero carousel-item relative w-full">
            <img src="{{ asset('images/article3.jpg') }}" class="h-[80vh] w-[100vw] " />
            <div class="hero-overlay bg-opacity-60"></div>
            <div class="hero-content text-center text-neutral-content">
                <div class=" max-w-2xl">
                    <h1 class="mb-5 text-7xl font-bold">Explore the World of Knowledge</h1>
