...
<body>
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="relative" id="profileDropdown">
                    ...
                    <ul class="absolute right-0 mt-2 w-48 bg-white rounded-md overflow-hidden shadow-xl z-10 hidden"
                        ...
                        <li>
                        <li><a href="{{route('allReservation')}}"
    ...
    <footer class="flex flex-col   bg-slate-300 ">
                ...
                <div class="flex flex-col justify-center  items-center w-full my-5">
                    ...
                    <div class="flex flex-col items-center gap-6 mb-4 mt-4">
                        <div
                            ...
                            <a href="javascript:void(0)" class="text-gray-600 hover:text-gray-900">Home</a>
                            <a href="javascript:void(0)" class="text-gray-600 hover:text-gray-900">Library</a>
                            <a href="javascript:void(0)" class="text-gray-600 hover:text-gray-900">Cafeteria</a>
                            <a href="javascript:void(0)" class="text-gray-600 hover:text-gray-900">Accommodation</a>
